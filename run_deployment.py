...
def main(config: str, min_accuracy: float):
    ...
    #fetch existing services with same pipeline, step name and model name
    ...
    if existing_services:
        ...
        if service.is_running:
            ...
            print(
                f"The MLflow prediction server is in a failed states:\n"
                f" Last states: '{service.status.state.value}'\n"
